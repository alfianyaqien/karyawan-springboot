package com.alfian.test.service.oauth;

import com.alfian.test.model.oauth.Client;
import com.alfian.test.model.oauth.Role;
import com.alfian.test.model.oauth.RolePath;
import com.alfian.test.model.oauth.User;
import com.alfian.test.repository.oauth.ClientRepository;
import com.alfian.test.repository.oauth.RolePathRepository;
    ...
    public void insertClients(String password) {
        for (String c : clients) {
            ...
            if (null == oldClient) {
                ...
                oldClient.setAccessTokenValiditySeconds(28800);//1jam 3600 :token valid : seharian kerja : normal 1 jam
